  ...
  return (
    <main className="min-h-[calc(100vh-4rem)] bg-zinc-950 flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -top-[15%] left-1/2 -translate-x-1/2 w-200 h-125z   bg-lime-500/10 blur-[140px] rounded-full" />
        <div className="absolute top-[20%] -left-[10%] w-100 h-100 bg-lime-600/5 blur-[100px] rounded-full" />
      </div>
